...
public class MultiChatServer {
	// 대화명, 클라이언트의 Socket을 저장하기 위하 Map변수 선언
	private Map<String, Socket> clients; //String=대화명
	...
	class ServerReceiver extends Thread{
		...
		public void run() {
			...
			try {
				...
				while(dis != null) {
					sendMessage(dis.readUTF(), name); //파라미터 두개짜리 , 채팅메시지
				}

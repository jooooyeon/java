...
import kr.or.ddit.member.MyBatisUtilBoard;
...
public class MyBatisBoardDao {
	...
	public <T> T selectOne(String statement, Object parameter) {
		SqlSession sqlSession = MyBatisUtilBoard.getInstance(true); // 세션열기 (오토커밋)
		...
		try {
			...
			throw new RuntimeException("마이바티스에서 데이터 조회 중 예외발생12!!!", e);
		} finally {
			sqlSession.close();
		}

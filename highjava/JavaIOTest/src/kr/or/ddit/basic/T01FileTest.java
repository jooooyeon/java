...
public class T01FileTest {
	public static void main(String[] args) throws IOException {
		...
		// 같음 => File file = new File("d:\\D_Other/test.txt");
		System.out.println("파일명 : " + file.getName());
		System.out.println("파일여부 : " + file.isFile()); //파일이 없으면 false나옴
		System.out.println("디렉토리(폴더)여부 : " + file.isDirectory());
		System.out.println("-------------------------------------------");
		
		File file2 = new File("d:/D_Other"); //폴더
		...
		File file4 = new File(".\\D_Other\\test\\..", "test.txt"); //상대경로<-프로젝트시 많이사용됨
